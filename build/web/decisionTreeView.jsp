<%-- 
    Document   : decisionTreeView
    Created on : Feb 11, 2016, 7:14:12 PM
    Author     : joao
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="col-lg-3">
                <h2>Análise</h2>
                <p><strong>Algoritmo Utilizado: </strong>J48</p>
                ...
                <form action="DecisionTree" method="GET">
                    <input type="hidden" name="fileName" value="<%=fileName%>" />
                    <div class="form-group">
                        <button type="submit" class="btn btn-default" name="action" id="download" value="download">Download Árvore de Decisão</button>
                    </div>
                </form>
            </div>
            <div class="col-lg-7">
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                // Set chart options
                var options = {'title': 'Precisão da árvore de decisão',
                    'width': 500,
                    'height': 400};
